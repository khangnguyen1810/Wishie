---
name: dev.4a.plan-and-implement-code-review-testing
description: "Plan and implement code review for testing files. Refactor test code based on SRP, KISS, DRY, YAGNI, and SOLID principles using parallel blind fast writers."
...
<userInput>
USER_INPUT = Optional testing standards or focus areas for review
    ...
    <task id="2.2" title="Parallel Blind Fast Writer Refactoring">
        ...
        ```json
        {
            ...
            "prompt": "EXECUTE workflow with context:
                ...
                USER_CONVENTION = [SYSTEM_TESTING_CONVENTION]
...
<phase number="3" name="Parallel Implementation Auditors">
    <task id="3.1" title="Parallel Auditor Execution">
        ...
        ```json
        {
            ...
            "description": "Execute Code Review Auditor",
            "prompt": "EXECUTE workflow with context:
                USER_INPUT = [USER_INPUT]
                USER_CONVENTION = [SYSTEM_TESTING_CONVENTION]"
        }
