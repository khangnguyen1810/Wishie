...
- [ ] **Scenario: Multiple rapid taps on "Next" do not skip steps or corrupt step index** ❌ FAILED
  ...
  - **Affected Files**:
    - [Wishie/CustomView/HomeTutorialOverlayView.swift](../../../../../Wishie/CustomView/HomeTutorialOverlayView.swift) — `onNext` closure (line ~44): `currentStep += 1` has no upper-bound guard
    - [Wishie/CustomView/HomeTutorialOverlayView.swift](../../../../../Wishie/CustomView/HomeTutorialOverlayView.swift) — view body (line ~32): `let currentStepData = steps[currentStep]` — unsafe subscript, crashes if `currentStep >= 3`
    - [Wishie/CustomView/CoachMarkOverlayView.swift](../../../../../Wishie/CustomView/CoachMarkOverlayView.swift) — `actionButton` (line ~115): guard relies on stale `stepIndex` prop, not on live `@State`, making it unreliable under rapid taps
