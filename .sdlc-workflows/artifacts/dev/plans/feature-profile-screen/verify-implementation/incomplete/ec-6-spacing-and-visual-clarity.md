...
- [ ] **Scenario: Spacing between profile info rows is consistent and clearly separates each row** ❌ FAILED
...
- [ ] **Scenario: Horizontal padding is applied so rows do not touch screen edges** ❌ FAILED
