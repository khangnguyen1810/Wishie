...
- [ ] **Scenario: Completing onboarding transitions app state from .welcome to .unauthenticated** ❌ FAILED
...
- [ ] **Scenario: LoginOrSignUpScreen is displayed with correct transition animation when entering auth state** ❌ FAILED
