...
- [x] **Scenario: Bottom sheet renders gradient background and header label**
...
- [x] **Scenario: Bottom sheet option rows render with themed white card and gradient icon container**
