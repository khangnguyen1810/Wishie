...
- [ ] **Scenario: Tapping a My List card zooms into WishlistDetailScreen with card-matched origin**
...
- [ ] **Scenario: Tapping a Friend's List card zooms into WishlistDetailScreen with card-matched origin**
...
- [ ] **Scenario: Existing @Namespace animation is reused — no additional namespace declared**
...
- [ ] **Scenario: matchedTransitionSource is scoped to the card ZStack, not the NavigationLink**
